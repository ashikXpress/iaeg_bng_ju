...
class NewsController extends Controller
{
    public function basicNewsAll() {
        $news = News::with('categoryName','userName')->where('category_id',1)->paginate(8);
    ...
    {
        $news = News::with('categoryName','userName')->where('category_id',2)->paginate(8);
    ...
    {
        return view('admin.gallery.yajra');
    }
}
